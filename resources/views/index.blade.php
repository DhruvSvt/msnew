            ...
            <ul class="fullbody">
                <li class="wow zoomIn">
                    <a href="{{ route('service') }}" class="a">
                        <div class="img fullbody"><img src="{{ config('app.url') }}/assets/images/security.jpeg"
                                alt="">
                        </div>
                ...
                <li class="wow zoomIn">
                    <a href="{{ route('service') }}" class="a">
                        <div class="img fullbody"><img src="{{ config('app.url') }}/assets/images/house.jpg"
                                alt=""></div>
                        <div class="text fullbody">
                ...
                <li class="wow zoomIn">
                    <a href="{{ route('service') }}" class="a">
                        <div class="img fullbody"><img src="{{ config('app.url') }}/assets/images/facility.jpeg"
                                alt="">
                        </div>
                        <div class="text fullbody">
                ...
                <li class="wow zoomIn">
                    <a href="{{ route('service') }}" class="a">
                        <div class="img fullbody"><img src="{{ config('app.url') }}/assets/images/cctv.jpeg"
                                alt=""></div>
                        <div class="text fullbody">
                ...
                <li class="wow zoomIn">
                    <a href="{{ route('service') }}" class="a">
                        <div class="img fullbody"><img src="{{ config('app.url') }}/assets/images/cinema.jpeg"
                                alt=""></div>
                        <div class="text fullbody">
                ...
                <li class="wow zoomIn">
                    <a href="{{ route('service') }}" class="a">
                        <div class="img fullbody"><img
                                src="{{ config('app.url') }}/assets/images/abe3ccb654cff8fff1e1a735e052ecd5.jpg"
                                alt="">
                        </div>
                        <div class="text fullbody">
